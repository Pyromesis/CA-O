...
public sealed partial class GamingPage : Page
{
    ...
    private async void OnScanClick(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            {
                AntiCheatText.Text = "No se han detectado servicios/drivers de anti-cheat conocidos.";
            }
            else
            {
                AntiCheatText.Text = string.Join("\n", antiCheats.Select(cheat =>
            ...
            VendorText.Text = context.GpuVendor switch
            {
                ...
                _ => "Detecte el panel del fabricante de su GPU para tecnologías de latencia nativas (Reflex, Anti-Lag). No existen hacks de registro fiables que las sustituyan.",
            };
        }
        catch (Exception ex)
        {
