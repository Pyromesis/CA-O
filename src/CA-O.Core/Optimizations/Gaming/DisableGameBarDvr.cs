...
public sealed class DisableGameBarDvr : RegistryOptimizationBase
{
    ...
    public override OptimizationDefinition Definition => new()
    {
        ...
        TooltipEs = "GameDVR_Enabled=0 y AppCaptureEnabled=0. Pierdes Win+G y los clips automáticos; gana estabilidad de frametime. Si solo te molesta grabar en segundo plano, basta Desactivar capturas en segundo plano.",
