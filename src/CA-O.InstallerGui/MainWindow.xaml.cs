...
internal void OnCancelClick(object sender, RoutedEventArgs e)
{
    ...
    {
        UpdateProgress(5, "Descargando payload (394 MB)...", "Descargando desde GitHub Release v2.1.4");
        var zipUrl = "https://github.com/Pyromesis/CA-O/releases/download/v2.1.4/CA-O-2.1.4-win-x64.zip";
        var fallbackUrl = "https://github.com/Pyromesis/CA-O/releases/latest/download/CA-O-2.1.4-win-x64.zip";
        var fallbackOld = "https://github.com/Pyromesis/CA-O/releases/download/v2.1.2/CA-O-2.1.2-win-x64.zip";
