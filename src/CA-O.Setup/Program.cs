...
{
    Console.WriteLine("Payload no local — descargando desde GitHub Release v2.1.1...");
    var zipUrl = "https://github.com/Pyromesis/CA-O/releases/download/v2.1.1/CA-O-2.1.1-win-x64.zip";
    var fallbackUrl = "https://github.com/Pyromesis/CA-O/releases/download/v2.1.0/CA-O-2.1.0-win-x64.zip";
