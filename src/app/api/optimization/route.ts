  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        taxonomyNote: 'group/subgroup/kind + evidence-based impact. kind=repair-action|maintenance|cosmetic|diagnostic items are not performance optimizations.',
        groupCounts: Object.entries(optimizations.reduce((acc, opt) => {
