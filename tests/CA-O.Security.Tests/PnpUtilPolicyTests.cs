...
public sealed class PnpUtilPolicyTests
{
    ...
    [InlineData(@"SWD\DAFUPNPPROVIDER\UUID:AFE9B6B8-28CE-4C6E-B089-7BDFD65B170D")]
    [InlineData(@"SWD\DAFUPNPPROVIDER\UUID:2D1F4ED0-FA69-11BE-AB94-6EE48481C22E")]
    [InlineData(@"SWD\WPDBUSENUM\_??_USBSTOR#DISK&VEN_GENERIC&PROD_FLASH_DISK&REV_8.07#FA169B4B8#0#{53F56307-B6BF-11D0-94F2-00A0C91EFB8B}")]
    [InlineData(@"USB\VID_05AC&PID_1281\SDOM_01_CPID:8030_CPRV:11_CPFM:03_SCEP:01_BDID:04_ECID:001135A93C52402E_IBFL:3C_SRNM:[DX3D9PFKN736]")]
